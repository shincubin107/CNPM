...
namespace QuanliBanHang
{
    public partial class formBaoCao : Form
    {
        ...
        public void PDF(DataGridView dataGridViewBaoCao , string filename)
        {
            ...
            BaseFont bf = BaseFont.CreateFont("C:\\Users\\shinc\\Downloads\\VietFontsWeb1_ttf\\vuArial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
            ...
            if (savefiledialoge.ShowDialog() == DialogResult.OK)
            {
                ...
                MessageBox.Show("Lưa báo cáo thành công", "Thông báo");
            }
        }
